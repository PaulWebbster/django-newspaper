...
urlpatterns = [
    ...
    url(r'^(?P<year>[0-9]+)/$', NewsArchivalListView.as_view(), name='news_list_archival'),
    url(r'^(?P<year>[0-9]+)/(?P<month>[0-9]+)/$', NewsArchivalListView.as_view(), name='news_list_archival'),
    url(r'^(?P<year>[0-9]+)/(?P<month>[0-9]+)/(?P<day>[0-9]+)/$', NewsArchivalListView.as_view(),
